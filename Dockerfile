...
#RUN yum upgrade -y
RUN yum install -y python-devel python-pip gcc libffi-devel openssl-devel s3cmd git
RUN ["pip", "install", "buildbot==0.8.10", "txgithub==15.0.0", "eliot", "apache-libcloud", "service_identity", "git+https://github.com/ClusterHQ/machinist@fd749b6e03ba1856b12378dc366fc05d4e0578cc#egg-name=machinist"]
